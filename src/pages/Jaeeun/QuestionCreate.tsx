...
const QuestionCreate = () => {
  return (
    <div className="flex w-full flex-col items-center py-10">
      <h1 className="mb-6 w-full max-w-[944px] text-2xl font-bold">
        질문 작성하기
      </h1>

      <Card className="flex w-full max-w-[944px] flex-col gap-[10px] rounded-[20px] border pt-10 pr-[38px] pb-10 pl-[38px]">
        <Input
          className="h-[60px] w-full rounded-[4px] border px-[16px] py-[10px]"
      ...
      <Card className="mt-5 flex min-h-[677px] w-full max-w-[944px] flex-col rounded-[20px]">
        ...
        <div className="flex flex-1">
          ...
          <Card className="flex flex-1 flex-col rounded-none p-4">
            <Textarea
              className="flex-1 resize-none rounded border p-3"
              placeholder="내용을 입력해주세요"
            />
